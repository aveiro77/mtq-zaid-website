...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Tambah RAB</h1>
</div> 

<div class="col-lg-8">
    <form method="post" action="/dashboard/budgets" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
          <label for="description" class="form-label">Uraian Pekerjaan</label>
          <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ old('description') }}" required autofocus>
          @error('description')
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('budget') is-invalid @enderror" id="budget" name="budget" value="{{ old('budget') }}" required autofocus>
            @error('budget')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
