...
<div class="col-lg-8">
    <form method="post" action="/dashboard/donates" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ old('address') }}" required autofocus>
          @error('address')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control @error('nominal') is-invalid @enderror" id="nominal" name="nominal" value="{{ old('nominal') }}" required autofocus>
          @error('nominal')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control @error('donate_date') is-invalid @enderror" id="donate_date" name="donate_date" value="{{ old('donate_date') }}" required autofocus>
          @error('donate_date')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
