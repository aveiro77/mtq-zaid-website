...
@section('container')  
  ...
  <section class="py-2">
    <div class="container py-2">
      <h2 class="my-4">Investasikan Segera Harta Anda Sebagai Bekal di Akhirat Kelak Dengan Program Wakaf Tunai Pembangunan</h2>
      <div class="row">
        <div class="col-lg-8">

          <figure class="text-center mt-4">
            <img src="/img/laman/bangunan-pondok.jpg" alt="bangunan-pondok.jpg" class="figure-img img-fluid">
            <figcaption class="text-muted text-center py-1 text-uppercase font-weight-bold small">Progress Pembangunan </figcaption>
          </figure>
